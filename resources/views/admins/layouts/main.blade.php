...
<head>
    <meta charset="utf-8">
    <link href="{{ asset('enigma/compiled') }}/dist/images/logoSkandaGoV5.png" class="logo__image w-100 h-[1000px] mt-2"
        rel="shortcut icon">
    ...
    <title>SkandaGo | Admin {{ $title }}</title>
    <!-- BEGIN: CSS Assets-->
            ...
            <ul class="scrollable__content py-2">
                <li>
                    <a href="{{ route('admin.classes.index') }}"
                        class="menu {{ request()->routeIs('admin.classes.*') ? 'menu--active' : '' }}">
                ...
                <li>
                    <a href="javascript:;" class="menu {{ request()->routeIs('admin.user.*') ? 'menu--active' : '' }}">
                        <div class="menu__icon"> <i data-lucide="settings"></i> </div>
                        <div class="menu__title">
                            Manage Users
                            <div
                                class="menu__sub-icon {{ request()->routeIs('admin.user.*') ? 'transform rotate-180' : '' }}">
                                <i data-lucide="chevron-down"></i>
                            </div>
                        </div>
                    </a>

                    <ul class="{{ request()->routeIs('admin.user.*') ? 'menu__sub-open' : 'hidden' }}">
                        <li>
                            <a href="{{ route('admin.user.admin.index') }}"
                                class="menu {{ request()->routeIs('admin.user.admin.*') ? 'menu--active' : '' }}">
                        ...
                        <li>
                            <a href="{{ route('admin.user.teacher.index') }}"
                                class="menu {{ request()->routeIs('admin.user.teacher.*') ? 'menu--active' : '' }}">
                                <div class="menu__icon"> <i data-lucide="user-plus"></i> </div>
                        ...
                        <li>
                            <a href="{{ route('admin.user.student.index') }}"
                                class="menu {{ request()->routeIs('admin.user.student.*') ? 'menu--active' : '' }}">
                                <div class="menu__icon"> <i data-lucide="user-plus"></i> </div>
                ...
                <li>
                    <a href="{{ route('admin.subjects.index') }}"
                        class="menu {{ request()->routeIs('admin.subjects.*') ? 'menu--active' : '' }}">
                ...
                <li>
                    <a href="#" class="menu {{ request()->routeIs('admin.achievements.*') ? 'menu--active' : '' }}">
                        <div class="menu__icon"> <i data-lucide="award"></i> </div>
                        <div class="menu__title"> Achievements </div>
                    </a>
                </li>

                <li>
                    <a href="#" class="menu {{ request()->routeIs('admin.majors.*') ? 'menu--active' : '' }}">
                ...
                <li>
                    <a href="#" class="menu {{ request()->routeIs('admin.schedules.*') ? 'menu--active' : '' }}">
                ...
                <li>
                    <a href="#" class="menu {{ request()->routeIs('admin.announcements.*') ? 'menu--active' : '' }}">
    ...
    <div
        ...
        <div class="h-full flex items-center">
            ...
            <div class="intro-x dropdown w-8 h-8">
                <div class="dropdown-toggle w-8 h-8 mb-1 rounded-full overflow-hidden shadow-lg image-fit zoom-in scale-110"
